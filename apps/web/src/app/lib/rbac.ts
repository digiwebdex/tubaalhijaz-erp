...
const PATH_ANY_OF: Record<string, readonly string[]> = {
  ...
  "/flight-master": [P.MANAGE_FLIGHTS],
  "/flight-schedule": [P.MANAGE_FLIGHTS],
  "/flight-ops-control": [P.MANAGE_FLIGHTS],
  "/ground-ops": [P.MANAGE_FLIGHTS],
  "/meet-assist": [P.MANAGE_FLIGHTS],
  "/command-center": [P.MANAGE_FLIGHTS],
